...
=> It can access a match without rendering a Route. 
If it is provided with no arguments, it returns the closest match in the component or its parents.
1. How would you explain form validation to someone who has never programmed before?
=> It checks if the provided information in the form from users are valid.
1. In 1-2 sentences, define end to end testing.
=> It is software testing method. It checks workflows from beginning to the end
